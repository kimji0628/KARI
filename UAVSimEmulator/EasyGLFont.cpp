#include "StdAfx.h"
#include "EasyGLFont.h"




CEasyGLFont::CEasyGLFont(void)
{
}

CEasyGLFont::CEasyGLFont( HDC hDC, char* fontName )
{
	BuildFont( hDC, fontName );
}


CEasyGLFont::~CEasyGLFont()
{
	KillFont();
}
...
int
CEasyGLFont::BuildFont( HDC hDC, char* fontName, int height, int weight, DWORD italic )				// Build Our Bitmap Font
{
...
void
CEasyGLFont::KillFont(void)									// Delete The Font
{
	glDeleteLists(m_fontBase, 96);							// Delete All 96 Characters
}

void
CEasyGLFont::glPrint(const char *fmt, ...)					// Custom GL "Print" Routine
{
...
void
CEasyGLFont::OutTextXY( int x, int y, double* color, const char *fmt, ... )	// Custom GL "Print" Routine
{
	char		text[256];								// Holds Our String
	va_list		ap;										// Pointer To List Of Arguments
